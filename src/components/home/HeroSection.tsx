    ...
    <div className="relative w-full min-h-[40vh] md:min-h-[60vh] overflow-hidden rounded-xl">
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12">
        ...
        <p className="text-primary-foreground/90 max-w-lg mb-6">
          Лучшие треки для твоего летнего настроения. Слушай новую музыку и
          открывай для себя талантливых исполнителей.
        </p>
        <div className="flex flex-wrap gap-4">
          ...
          <Button
            variant="outline"
            className="bg-background/20 hover:bg-background/30 rounded-full border-white"
          >
            Добавить в плейлист
          </Button>
        </div>
