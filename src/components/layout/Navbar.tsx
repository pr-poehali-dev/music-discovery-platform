...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-background/90 backdrop-blur-md border-b border-border flex items-center px-4 md:px-6">
      <div className="flex-1 flex items-center gap-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="hidden md:inline-block">BlackTunes</span>
        </Link>
        ...
        <div className="relative hidden md:flex flex-1 max-w-md">
          <Input
            ...
            className="pl-10 bg-muted/50 border-gray-800"
          />
          <Icon
            name="Search"
