...
const MusicPlayer = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 h-20 bg-background/90 backdrop-blur-md border-t border-border flex items-center px-4">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-3 gap-4">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full hidden sm:flex items-center gap-2 mt-1">
            ...
            <Slider value={[progress]} max={100} step={1} className="flex-1" />
